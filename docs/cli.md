...
|---|---:|---|---|
| `--cwd` | yes | `init`, `validate`, `run`, `report` | Resolves all project-relative inputs from this directory. |
| `--contract` | yes | `validate`, `run` | Uses this YAML, YML, or JSON contract instead of discovery. |
